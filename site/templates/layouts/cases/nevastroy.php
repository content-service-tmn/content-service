      ...
      <section class="case">
        ...
        <div class="case__grid">
          <div class="case__cell case__cell_kibbler case__cell_text">
            <h2>Все о модели</h2>
            <p>Нами была разработана 3D-модель с анимацией, которой может управлять сам пользователь. Вы можете: поменять цвет модели, руководить процессом сваескусывания, <br>смотреть интерактив с разных ракурсов, изучая детали этого сложного оборудования.</p>
          </div>
        </div>
        <div class="case__grid">
