<section class="header header_about">
  <a href="#canvas" class="burger" data-uk-offcanvas="{mode: 'slide'}"></a>
</section>
<section class="about">
        ...
        <div class="about__items">
          <div class="about__item">
            ...
            <div class="about__text">
              <p>Content Service – digital агенство полного цикла.</p>
              <p>Наша основная компетенция создание системы продаж в интернете.</p>
              <p>
                Иначе говоря, интернет-филиала Вашей компании.
              </p>
            </div>
          </div>
          <div class="about__item">
            ...
            <div class="about__text">
              <p>
                Создать стиль компании
              </p>
              <p>
                Разработать сайт
              </p>
              <p>
                Привести на него целевую аудиторию
              </p>
              <p>
                Учесть и настроить отдел продаж
              </p>
              <p>
                Вести корпоративные соц сети
              </p>
              <p>
                Создавать в соц сетях максимальные охваты аудитории
              </p>
            </div>
          </div>
          <div class="about__item">
